...
<div class="container d-md-none d-sm-block">
  <div class="row">
    <div class="menu_album col"><a href="${albumlink}">главная</a></div>
    <div class="menu_album col"><a href="${albumlink}">меню</a></div>
    <div class="menu_album col"><a href="${baseLink}">выход</a></div>
  </div>
</div>
`;
...
document.getElementById('album-menu-container').innerHTML = menuHTML;
